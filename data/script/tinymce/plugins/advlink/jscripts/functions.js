...
function init() {
	...
	if (action == "update") {
		...
		// Setup form data
		if (href.substring(0, 7)=='intern:') {
			setFormValue('hrefintern', href.substring(8));
		}
		else if (href.substring(1, 7)=='intern:') {
			setFormValue('hrefintern', href.substring(9));
		}
...
function setAllAttribs(elm) {
	...
	var hrefintern = formObj.hrefintern.value;
	var hrefdownload = formObj.hrefdownload.value;
	...
	if (hrefintern!=0) {
		setAttrib(elm, 'href', 'intern:#'+hrefintern+';'+lang);
		setAttrib(elm, 'mce_href', 'intern:#'+hrefintern+';'+lang);
	}
