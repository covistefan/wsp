...
<head>
    ...
    <link rel="stylesheet" href="/<?php echo WSP_DIR; ?>/media/layout/themify-icons.css" />
    <!-- extended desktop stylesheets -->
    <link rel="stylesheet" href="/<?php echo WSP_DIR; ?>/media/layout/bootstrap-tour.min.css" />
...
<?php if(isset($_SESSION['wspvars']['addpagecss']) && is_array($_SESSION['wspvars']['addpagecss']) && count($_SESSION['wspvars']['addpagecss'])>0): foreach($_SESSION['wspvars']['addpagecss'] AS $addk => $addv): ?>
    <link rel="stylesheet" href="/<?php echo WSP_DIR; ?>/media/layout/<?php echo trim($addv); ?>" />
<?php endforeach; endif; ?>
    ...
    <link rel="stylesheet" href="/<?php echo WSP_DIR; ?>/media/layout/klorofil.css" />
    <!-- load icons -->
    ...
    <script src="/<?php echo WSP_DIR; ?>/data/script/jquery/js/jquery-ui.min.js"></script>
    ...
    <script src="/<?php echo WSP_DIR; ?>/data/script/bootstrap/bootstrap-tour.min.js"></script>
    <script src="/<?php echo WSP_DIR; ?>/data/script/jquery/jquery.slimscroll.min.js"></script>
...
<?php if(isset($_SESSION['wspvars']['addpagejs']) && is_array($_SESSION['wspvars']['addpagejs']) && count($_SESSION['wspvars']['addpagejs'])>0): foreach($_SESSION['wspvars']['addpagejs'] AS $addk => $addv): ?>
    <script src="/<?php echo WSP_DIR; ?>/data/script/<?php echo trim($addv); ?>"></script>
<?php endforeach; endif; ?>
    <script src="/<?php echo WSP_DIR; ?>/data/script/klorofilpro.min.js"></script>
    <?php /*
