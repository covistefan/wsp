        ...
        <div class="panel-body">
            ...
            foreach ($modrights_res['set'] AS $mrsk => $mrsv):
                ...
                if ($wspmod_res['num']>0) {
                    ...
                    $wspmod['right'][$mrsv['guid']] = (isset($mrsv['right']) && trim($mrsv['right'])!='') ? 
                        trim($mrsv['right']) :
                        trim($mrsv['description']) ;
                    ...
                    $wspmod['possibilities'][$mrsv['guid']] = (trim($mrsv['possibilities'])!='') ? 
                        serialize(unserializeBroken($mrsv['possibilities'])) :
                        array(0,1) ;
