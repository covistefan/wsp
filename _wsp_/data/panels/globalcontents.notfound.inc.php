<div class="panel">
    <div class="panel-heading">
        <h3 class="panel-title"><?php echo returnIntLang('globalcontent no contents for lang 1', true); ?> "<?php echo (isset($_SESSION['wspvars']['sitelanguages']['longname'][(@array_keys($_SESSION['wspvars']['sitelanguages']['shortcut'], $_SESSION['wspvars']['workspacelang'])[0])]))?($_SESSION['wspvars']['sitelanguages']['longname'][(@array_keys($_SESSION['wspvars']['sitelanguages']['shortcut'], $_SESSION['wspvars']['workspacelang'])[0])]):$_SESSION['wspvars']['workspacelang']; ?>" <?php echo returnIntLang('globalcontent no contents for lang 2', true); ?></h3>
        <?php 
